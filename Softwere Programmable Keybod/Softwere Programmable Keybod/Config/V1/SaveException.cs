...
namespace WS.Theia.Tool.SoftwereProgrammableKeybod.Config.V1 {
	...
	public class SaveException:Exception {
		...
		/// <summary>
		/// SaveException クラスの新しいインスタンスを初期化します。
		/// </summary>
		public SaveException() : base() {
		}

		/// <summary>
		/// 指定したエラー メッセージを使用して、SaveException クラスの新しいインスタンスを初期化します。
		/// </summary>
		...
		/// <summary>
		/// 指定したエラー メッセージおよびこの例外の原因となった内部例外への参照を使用して、SaveException クラスの新しいインスタンスを初期化します。
		/// </summary>
		...
		/// <summary>
		/// シリアル化したデータを使用して、SaveException クラスの新しいインスタンスを初期化します。
		/// </summary>
